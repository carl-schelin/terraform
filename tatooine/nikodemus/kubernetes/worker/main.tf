...
# set the variables
  ...
  svc_bridge = "br0"
  svc_address = "10.100.103.13"
  mac_address = "52:54:00:9B:67:0D"
  ram_request = "4096"
  cpu_request = "2"
...
# set the variables
  ...
  svc_bridge = "br0"
  svc_address = "10.100.103.14"
  mac_address = "52:54:00:9B:67:0E"
  ram_request = "2048"
  cpu_request = "2"
  machine_image = "centos8_20g.qcow2"
...
# set the variables
  ...
  svc_bridge = "br0"
  svc_address = "10.100.103.15"
  mac_address = "52:54:00:9B:67:0F"
  ram_request = "2048"
  cpu_request = "2"
  machine_image = "centos8_20g.qcow2"
