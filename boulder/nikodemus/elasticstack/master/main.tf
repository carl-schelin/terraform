...
module "boulder-server-17" {
  ...
  user_data_path = "${path.module}/bldr1cuomifem1.yaml"
}
...
module "boulder-server-18" {
  ...
  cpu_request    = "2"
  machine_image  = "centos8_20g.qcow2"
  user_data_path = "${path.module}/bldr1cuomifem2.yaml"
}
...
module "boulder-server-19" {
  ...
  cpu_request    = "2"
  machine_image  = "centos8_20g.qcow2"
  user_data_path = "${path.module}/bldr1cuomifem3.yaml"
}
