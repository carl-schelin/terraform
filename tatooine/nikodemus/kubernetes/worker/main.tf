...
# set the variables
  ...
  user_data_path = "${path.module}/tato1cuomknode1.yaml"
}
...
# set the variables
  ...
  cpu_request = "2"
  machine_image = "centos8_20g.qcow2"
  user_data_path = "${path.module}/tato1cuomknode2.yaml"
}
...
# set the variables
  ...
  cpu_request = "2"
  machine_image = "centos8_20g.qcow2"
  user_data_path = "${path.module}/tato1cuomknode3.yaml"
}
