...
module "nederland-server-03" {
  ...
  user_data_path = "${path.module}/ndld2cuombackup1.yaml"
}
...
module "nederland-server-08" {
  ...
  cpu_request    = "2"
  machine_image  = "centos8_20g.qcow2"
  user_data_path = "${path.module}/ndld2cuomsamba1.yaml"
}
