...
# set the variables
  ...
  svc_bridge = "br0"
  svc_address = "10.100.101.17"
  mac_address = "52:54:00:9B:65:11"
  ram_request = "4096"
  cpu_request = "2"
...
# set the variables
  ...
  svc_bridge = "br0"
  svc_address = "10.100.101.18"
  mac_address = "52:54:00:9B:65:12"
  ram_request = "4096"
  cpu_request = "2"
  machine_image = "centos8_20g.qcow2"
...
# set the variables
  ...
  svc_bridge = "br0"
  svc_address = "10.100.101.19"
  mac_address = "52:54:00:9B:65:13"
  ram_request = "4096"
  cpu_request = "2"
  machine_image = "centos8_20g.qcow2"
