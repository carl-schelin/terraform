...
# set the variables
  ...
  svc_bridge = "br0"
  svc_address = "10.100.104.46"
  mac_address = "52:54:00;9B;68:2E"
  ram_request = "4096"
  cpu_request = "2"
...
# set the variables
  ...
  svc_bridge = "br0"
  svc_address = "10.100.104.49"
  mac_address = "52:54:00;9B;68:31"
  ram_request = "4096"
  cpu_request = "2"
  machine_image = "centos8_20g.qcow2"
...
# set the variables
  ...
  svc_bridge = "br0"
  svc_address = "10.100.104.51"
  mac_address = "52:54:00;9B;68:33"
  ram_request = "4096"
  cpu_request = "2"
  machine_image = "centos8_20g.qcow2"
